...
export function Hero() {
  return (
    <section className="text-center mb-20 md:mb-32" aria-labelledby="hero-heading">
      <div className="max-w-4xl mx-auto">
        <Image
          ...
          priority
        />
        <h1 id="hero-heading" className="text-4xl md:text-6xl lg:text-7xl font-bold text-slate-900 mb-6 leading-tight">
          Transforme a sua
        ...
        <div className="mb-8 space-y-4">
          <p className="text-lg text-slate-700 max-w-2xl mx-auto">
            A Scooli utiliza inteligência artificial avançada para gerar automaticamente apresentações, planos de aula, testes e quizzes personalizados, alinhados com o currículo português.
          </p>
