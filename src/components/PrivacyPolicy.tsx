                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 leading-relaxed">
                      ...
                      comprometido em proteger os seus dados pessoais. Esta
                      Política de Privacidade informa-o sobre como recolhemos,
                      utilizamos, divulgamos e protegemos as suas informações
                      quando utiliza o nosso serviço, em conformidade com o
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <ul className="list-disc list-inside text-slate-600 space-y-1">
                          ...
                          <li>
                            Informações de contacto que nos forneça
                            voluntariamente
                          </li>
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside text-slate-600 space-y-1">
                          <li>
                            Dados de utilização do website (páginas visitadas,
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="list-disc list-inside text-slate-600 space-y-2">
                      ...
                      <li>
                        Melhorar e personalizar a sua experiência no nosso
                        website
                      </li>
                      <li>Responder às suas perguntas e pedidos de suporte</li>
                      <li>
                        Analisar o uso do website para melhorar os nossos
                        serviços
                      </li>
              ...
              <CardContent className="p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-slate-600 mb-4">
                      Tratamos os seus dados pessoais com base nas seguintes
                      bases legais:
                    </p>
                    <ul className="list-disc list-inside text-slate-600 space-y-2">
                      <li>
                        <strong>Consentimento:</strong> Quando nos dá
                        consentimento explícito para processar os seus dados
                      </li>
                      <li>
                      ...
                      <li>
                        <strong>Cumprimento legal:</strong> Quando necessário
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-slate-600 mb-4">
                      ...
                      partilhar os seus dados apenas nas seguintes
                      circunstâncias:
                    </p>
                    <ul className="list-disc list-inside text-slate-600 space-y-2">
                      <li>
                      ...
                      <li>
                        Para proteger os nossos direitos, propriedade ou
                        segurança
                      </li>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <ul className="list-disc list-inside text-slate-600 space-y-2">
                        <li>
                          <strong>Acesso:</strong> Solicitar cópias dos seus
                          dados pessoais
                        </li>
                        <li>
                      ...
                      <ul className="list-disc list-inside text-slate-600 space-y-2">
                        <li>
                          <strong>Portabilidade:</strong> Transferir os seus
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="list-disc list-inside text-slate-600 space-y-2">
                      ...
                      <li>
                        Alteração, divulgação ou processamento não autorizado
                      </li>
                    </ul>
                    <p className="text-slate-600 mt-4">
                      Utilizamos encriptação SSL/TLS para proteger a transmissão
                      de dados e armazenamos as informações em servidores seguros
                      com acesso restrito.
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="list-disc list-inside text-slate-600 space-y-2">
                      <li>
                        Dados de subscrição: Até cancelar a subscrição ou
              ...
              <CardContent className="p-8">
                <div className="text-center">
                  ...
                  <p className="text-slate-600 mb-6">
                    Se tiver questões sobre esta Política de Privacidade ou
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 leading-relaxed">
                      ...
                      you use our service, in line with the EU General Data
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <ul className="list-disc list-inside text-slate-600 space-y-1">
                          <li>Email address (when you sign up for updates)</li>
                          <li>Contact details you provide voluntarily</li>
              ...
              <CardContent className="p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="list-disc list-inside text-slate-600 space-y-2">
                      <li>
                        Send notifications about the Scooli launch and important
                        updates
                      </li>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="list-disc list-inside text-slate-600 space-y-2">
                      ...
                      <li>
                        <strong>Legal obligation:</strong> When necessary to
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-slate-600 mb-4">
                      ...
                      third parties for commercial purposes. We may share your
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <ul className="list-disc list-inside text-slate-600 space-y-2">
                        ...
                        <li>
                          <strong>Restriction:</strong> Restrict processing of
                          your data
                        </li>
                      </ul>
                      <ul className="list-disc list-inside text-slate-600 space-y-2">
                        <li>
                          <strong>Portability:</strong> Transfer your data to
                          another service
                        </li>
                        <li>
                        ...
                        <li>
                          <strong>Lodge a complaint:</strong> With the data
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="list-disc list-inside text-slate-600 space-y-2">
                      ...
                      <li>Unauthorized alteration, disclosure, or processing</li>
                    </ul>
                    <p className="text-slate-600 mt-4">
                      We use SSL/TLS encryption to protect data transmission and
                      store information on secure servers with restricted
                      access.
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="list-disc list-inside text-slate-600 space-y-2">
                      <li>
                        Subscription data: Until you unsubscribe or request
                        deletion
                      </li>
                      <li>Contact data: Up to 3 years after last contact</li>
                      <li>Usage data: Up to 2 years for analytics purposes</li>
                      <li>Legal data: As required by law</li>
                    </ul>
                  </div>
                </div>
              </CardContent>
