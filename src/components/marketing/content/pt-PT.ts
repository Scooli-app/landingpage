...
/**
 * Portuguese marketing copy. This is the copy that is live and indexed —
 * it was moved here verbatim from `data.ts` and must not be reworded as part
 * of an i18n change.
 */
  ...
  toolPages: [
    {
      ...
      relatedLinks: [
        { label: "Ver planos letivos", href: toolHref("sequencias-de-aulas") },
        { label: "Criar planos de aula", href: toolHref("plano-de-aula") },
        { label: "Gerar fichas de trabalho", href: toolHref("fichas-de-trabalho") },
      ],
      howToSteps: [
        {
    ...
    },
    {
      ...
      relatedLinks: [
        { label: "Ver planificações de unidade", href: toolHref("planificacoes") },
        { label: "Ver planos letivos", href: toolHref("sequencias-de-aulas") },
        { label: "Gerar fichas de trabalho", href: toolHref("fichas-de-trabalho") },
      ],
      howToSteps: [
    ...
    },
    {
      ...
      relatedLinks: [
        { label: "Ver planificações por unidade", href: toolHref("planificacoes") },
        { label: "Criar plano de aula individual", href: toolHref("plano-de-aula") },
    ...
    },
    {
      ...
      relatedLinks: [
        { label: "Ver fichas de trabalho", href: toolHref("fichas-de-trabalho") },
        { label: "Transformar documentos seus", href: toolHref("carregar-documentos") },
    ...
    },
    {
      ...
      relatedLinks: [
        { label: "Criar planos de aula", href: toolHref("plano-de-aula") },
        { label: "Gerar quizzes de revisão", href: toolHref("quizzes") },
    ...
    },
    {
      ...
      relatedLinks: [
        { label: "Criar fichas de trabalho", href: toolHref("fichas-de-trabalho") },
        { label: "Partir de um documento seu", href: toolHref("carregar-documentos") },
